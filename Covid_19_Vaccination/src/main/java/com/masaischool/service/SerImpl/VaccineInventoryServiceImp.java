...
public class VaccineInventoryServiceImp implements VaccineInventoryService {
	...
	// It ensures the provided vaccination center ID is valid, associates the inventory with the center, and saves the inventory to the repository
	@Override
	...
	// It checks for valid input parameters, sets the inventory ID, and saves the updated inventory to the repository.
	@Override
